...
import static edu.ecnu.yjsy.model.constant.Table.SPECIAL_PLAN;
...
public class SpecialPlan extends MetaCode {

    /**
     * 
     */
    private static final long serialVersionUID = -561500970509823947L;

    public SpecialPlan() {

    }

    public SpecialPlan(String code, String name) {
        this.code = code;
        this.name = name;
    }
