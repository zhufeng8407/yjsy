...
import static edu.ecnu.yjsy.model.constant.Table.EXAIMINEE_ORIGIN;
...
@Entity
@Table(name = EXAIMINEE_ORIGIN,
        uniqueConstraints = { @UniqueConstraint(columnNames = { META_CODE }),
                @UniqueConstraint(columnNames = { META_CODE, META_NAME }) })
public class ExamineeOrigin extends MetaCode {

    /**
     * 
     */
    private static final long serialVersionUID = 4765337166837174400L;

    public ExamineeOrigin() {

    }

    public ExamineeOrigin(String code, String name) {
        this.code = code;
        this.name = name;
    }
