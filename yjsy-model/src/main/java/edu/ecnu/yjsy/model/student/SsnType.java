...
import static edu.ecnu.yjsy.model.constant.Table.SSN_TYPE;
...
public class SsnType extends MetaCode {

    /**
     * 
     */
    private static final long serialVersionUID = -6108989007636513775L;

    public SsnType() {

    }

    public SsnType(String code, String name) {
        this.code = code;
        this.name = name;
    }
